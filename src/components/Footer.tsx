...
export default function Footer() {
  ...
  return (
    <footer className="flex w-full flex-col gap-4 rounded-2xl border border-main bg-bg p-4 lg:p-6">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 pt-1 pl-2">
              <p className="indent-4">
                Iniciado en 6to año de la Técnicatura, bajo la tutela de{" "}
                <a href="https://mattprofe.com.ar/web/" className="underline">
                  Mattprofe
                </a>
                , con el fin de obtener más conocimientos sobre la róbotica.
              </p>
              <p className="indent-4">
                Se pone en práctica el trabajo bajo presión en competencias
                institucionales con una fecha límite.
              </p>
            </div>
          </div>
        </article>
      </section>
      <section className="flex justify-between rounded-xl border border-main bg-bg p-2.5 pb-0 text-lg text-icon">
        <a
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="w-fill rounded-t-lg bg-main text-center text-xs">
              License
            </span>
          </div>
        </a>
